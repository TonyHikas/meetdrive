<b>Мои мероприятия(в которых я организатор)</b><br>
<a href="/profile/myevent/add">Добавить мероприятие</a>
<hr>
<?php echo 'Текущая: '.$page.' Максимальная: '.$max_page.' Всего: '.$count;?>
<?php if ($count==0){echo 'Не найдены записи'; $events = [];} ?>
<?php  foreach ($events as $event): ?>
    <a href="/profile/myevent/edit/<?php echo $event['id'];?>">
        <div class="shodItem">
...
<div class="pagin">
    <div class="pagnum">
        <?php $adrr = '/profile/myevent/'; if ($max_page ==0){$max_page=1;} ?>
        <?php if (($page!=1)): ?>
